...
class _AppState extends State<App> {
  ...
  static final String amqp_host="192.168.0.101";
  //+ forms
  final FormRepository formRepository= new FormRepository(
      BrokerClient('blue_queue', client: Client(settings:ConnectionSettings(host: amqp_host))));
  // final FormRepository formRepository= new FormRepository(
  //      BrokerClient('blue_queue'));
  //+
  //+ bus
  Client _amqpClient;
  MessageBus _bus;
